      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="reveal">
            ...
            {/* Stats or highlights */}
            {brand.content.aboutStats && (
              <div className="grid grid-cols-2 gap-6">
                {brand.content.aboutStats.map((stat, i) => (
                  <div key={i} className={`border-l-2 ${i === 0 ? 'border-brand-primary' : 'border-brand-accent'} pl-4`}>
                    <span className={`text-3xl font-heading font-bold ${i === 0 ? 'text-brand-primary' : 'text-brand-accent'}`}>
